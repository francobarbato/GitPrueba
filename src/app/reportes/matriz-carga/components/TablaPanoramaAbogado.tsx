...
function DesgloseAbogado({ abogado }: { abogado: AbogadoPanorama }) {
  const estados = [
    ...
    { label: "Bloqueadas", valor: abogado.tareasBloqueadas, color: "bg-red-100 text-red-700" },
  ].filter(e => e.valor > 0)
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      <div>
        <p className="text-xs font-semibold text-slate-500 uppercase tracking-wide mb-3">Tareas por estado</p>
      ...
      <div>
        <p className="text-xs font-semibold text-slate-500 uppercase tracking-wide mb-3">Tareas por prioridad</p>
        <div className="flex flex-wrap gap-2">
        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="bg-slate-50 border-y border-slate-200">
              ...
              <th className="text-center px-3 py-3 text-xs font-semibold text-slate-700 uppercase tracking-wider">Tareas activas</th>
              <th className="text-center px-3 py-3 text-xs font-semibold text-red-600 uppercase tracking-wider">Bloqueadas</th>
    ...
    <Card className="bg-white border border-slate-200 mb-6">
      <CardHeader className="pb-3">
        ...
        <p className="text-xs text-slate-500">
          Carga actual por profesional. Click en una fila para ver el desglose de tareas por estado y prioridad.
        </p>
      </CardHeader>
