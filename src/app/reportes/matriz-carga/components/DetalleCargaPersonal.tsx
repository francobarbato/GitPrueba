    ...
    <div className="space-y-4 mb-6">
      ...
      <Card className="bg-white border border-slate-200">
        ...
        >
          ...
          {casosExpandido ? <ChevronDown className="w-4 h-4 text-slate-400" /> : <ChevronRight className="w-4 h-4 text-slate-400" />}
        </button>
        {casosExpandido && (
      ...
      <Card className="bg-white border border-slate-200">
        ...
        >
          <div className="flex items-center gap-2">
            ...
            <span className="text-base font-semibold text-slate-800">Mis tareas activas</span>
            <span className="text-xs px-2 py-0.5 bg-blue-100 text-blue-700 rounded-full font-bold">{tareas.length}</span>
          </div>
          {tareasExpandido ? <ChevronDown className="w-4 h-4 text-slate-400" /> : <ChevronRight className="w-4 h-4 text-slate-400" />}
        </button>
        {tareasExpandido && (
          <CardContent className="pt-0 px-0 pb-0">
            <div className="flex items-center gap-2 px-4 pb-3 flex-wrap">
            ...
            {tareasFiltradas.length === 0 ? (
              <p className="text-sm text-slate-400 text-center py-6">{hayFiltroTareas ? "Sin tareas para los filtros seleccionados" : "Sin tareas activas"}</p>
            ) : (
              <div className="overflow-x-auto">
                <table className="w-full text-sm">
                  <thead>
