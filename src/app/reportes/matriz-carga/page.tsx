...
async function getMatrizCarga(abogadoId?: string) {
  ...
  // 2. Tareas activas (no terminales) — con detalle completo
  ...
  // 4. Tareas próximas a vencer (7 días)
  ...
  // 5. Tareas bloqueadas activas — con más detalle
  ...
  // Cuarto: contar tareas próximas a vencer por persona
  ...
  const tareasBloqueadasDetalle: TareaBloqueadaDetalle[] = tareasBloqueadasRaw.map(t => ({
    ...
    casoId: t.caso?.id ?? null,
    fechaVencimiento: t.fechaVencimiento ? t.fechaVencimiento.toISOString() : null,
    diasDesdeUltimoCambio: Math.max(0, Math.floor((ahora.getTime() - t.updatedAt.getTime()) / (1000 * 60 * 60 * 24))),
    responsable: t.responsable.nombre && t.responsable.apellido
      ? `${t.responsable.nombre} ${t.responsable.apellido}` : "Sin asignar",
  }))
  ...
  return {
    ...
    insights: {
      ...
      abConMasCapital: abConMasCapital && porcentajeCapitalConcentrado > 0 ? { nombre: abConMasCapital.nombre, porcentaje: porcentajeCapitalConcentrado } : null,
          ...
          <div className={`flex ${tieneProximas ? "xl:flex-row" : ""} flex-col`}>
            ...
            <div className="flex-1 p-6 min-w-0">
              <div className="max-w-7xl mx-auto">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-slate-500">
                        {vistaGeneral ? "Panorama actual de carga y distribución del equipo" : "Tu carga de trabajo actual: expedientes, tareas y capital"}
                      </p>
                    </div>
                  </div>
                </div>
                ...
                {/* Tabla tareas bloqueadas activas — solo vista personal */}
                ...
                <div className="mt-8 p-4 bg-slate-100 border border-slate-200 rounded-lg">
                  ...
                  <p className="text-xs text-slate-500">
                    ...
                    <strong>Tareas activas:</strong> En estado Pendiente, En proceso o Bloqueada.{" "}
                    <strong>Bloqueadas:</strong> Tareas activas que no pueden avanzar hasta destrabarse.{" "}
                    <strong>Por vencer:</strong> Tareas activas cuyo plazo vence en los próximos 7 días.{" "}
