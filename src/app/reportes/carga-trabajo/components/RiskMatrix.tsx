        ...
        <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
                ...
                <div>
                    ...
                    Casos con plazos criticos
                    </CardTitle>
                    <CardDescription>
                    Identificación de casos críticos por complejidad e inactividad.
                    </CardDescription>
                </div>
            </div>
                ...
                <tr key={caso.id} className="hover:bg-slate-50 transition duration-150 group">
                  ...
                  <td className="px-6 py-4 text-center">
                    <Badge variant="outline" className={`
                        ${caso.complejidad === 'Alta' ? 'border-purple-200 text-purple-700 bg-purple-50' : 
                          caso.complejidad === 'Media' ? 'border-blue-200 text-blue-700 bg-blue-50' : 
                  ...
                  <td className="px-6 py-4 text-center">
                    ...
                    <div className={`text-xs font-bold ${
                        caso.diasInactivo > 45 ? 'text-rose-600' : 
                        caso.diasInactivo > 15 ? 'text-amber-600' : 'text-emerald-600'
                    }`}>
