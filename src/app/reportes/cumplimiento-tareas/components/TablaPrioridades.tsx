...
/**
 * Misma definición que en page.tsx: incluye vencidas en el denominador.
 * Un evento "cumple" solo si fue completado en o antes de su vencimiento.
 * Completados con demora y vencidos NO cumplen el plazo.
 */
...
function calcularPrioridadFiltrada(tareasRaw: TareaRawPrioridad[], filtroPersona: string, filtroTipo: string, filtroCat: string): PrioridadData[] {
  ...
  return PRIORIDADES_ORDEN.map(prio => {
    ...
    return {
      ...
      // FIX: misma fórmula que en server — incluye vencidas en el denominador
