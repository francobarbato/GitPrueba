...
const BLOQUES: { titulo: string; descripcion: string; reportes: Reporte[] }[] = [
  ...
  },
  {
    ...
    reportes: [
      { titulo: "Cumplimiento de tareas", descripcion: "Cómo se trabajó: tareas cumplidas en plazo, con demora y vencidas", href: "/reportes/cumplimiento-tareas", icono: ClipboardCheck, color: "blue" },
      { titulo: "Matriz de carga de trabajo", descripcion: "Qué tenés encima hoy: expedientes, tareas activas y próximas a vencer", href: "/reportes/matriz-carga", icono: Briefcase, color: "cyan" },
      { titulo: "Composición de tareas", descripcion: "Qué tipo de trabajo hace el estudio: procesal vs interna, categorías, contexto", href: "/reportes/composicion-tareas", icono: BarChart3, color: "purple" },
      { titulo: "Distribución geográfica", descripcion: "Organización logística de visitas a tribunales", href: "/reportes/distribucion-geografica", icono: MapPinned, color: "emerald" },
    ],
  },
  {
  ...
  },
  {
    ...
    reportes: [
      { titulo: "Composición de cartera por fuero", descripcion: "Dónde está el volumen y el valor económico del estudio", href: "/reportes/composicion-cartera", icono: PieChart, color: "indigo" },
