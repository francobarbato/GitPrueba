...
export function TablaClientes({ clientesRecurrentes, clientesInactivos, esGerencial }: Props) {
  const [tabActiva, setTabActiva] = useState<"recurrentes" | "inactivos">("recurrentes")
